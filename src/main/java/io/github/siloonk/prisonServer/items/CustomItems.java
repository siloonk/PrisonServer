...
public class CustomItems {
    ...
    public ItemStack generateItem(ConfigurationSection section) {
        ...
        Component name = miniMessage.deserialize(section.getString("name"));
        Material material = Material.matchMaterial(section.getString("material"));
        ArrayList<Component> lore = Util.convertStringListToComponentList(section.getStringList("lore"));
