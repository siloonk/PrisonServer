...
public class QuantumMinerEnchantment extends Enchantment {
    ...
    public QuantumMinerEnchantment(Component name, Component description, int maxLevel, int baseCost, double costIncrease, double chanceAtMaxLevel, double baseChance) {
